...
#define APIKEY "XXXXXXXXXXXXXXX" //  api key your twitter

#define TARGET_IP "184.106.153.149"///         //direccion IP thingspeak

#define TARGET_PORT "80"          ///  puerto 80

#define ID "xxxxxxxxxxx"  //name of wireless access point to connect to   - Red de inhalambrica wifi 
#define PASS "xxxxxxxxxxx"  //wifi password                          - Contraseña de Wifi 
